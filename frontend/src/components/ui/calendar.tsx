  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button:
          'h-6 w-6 bg-transparent p-0 opacity-70 hover:opacity-100 border-0 transition-opacity flex items-center justify-center',
        nav_button_previous: '',
        nav_button_next: '',
        table: 'w-full border-collapse space-y-1',
        head_row: 'flex',
        head_cell:
          'text-muted-foreground w-8 font-normal text-[0.8rem] flex items-center justify-center',
