...
export default function EditBookingModal({ 
  ...
  const [localShowClashWarning, setLocalShowClashWarning] = useState(showClashWarning);
  ...
  // Update warning banner when prop changes
  useEffect(() => {
    setLocalShowClashWarning(showClashWarning);
  }, [showClashWarning]);
              ...
              <div className="grid grid-cols-[1fr_2fr] items-center">
                ...
                <div className="flex items-center">
                  <input
                    id="date"
                    type="text"
                    className="flex h-6 w-8/12 rounded-[5px] border border-input border-stone-400 bg-transparent px-3 py-1 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
              ...
              <div className="grid grid-cols-[1fr_2fr] items-center">
                ...
                <div className="flex items-center">
                  <input
                    id="start-time"
                    type="text"
                    className="flex h-6 w-6/12 rounded-[5px] border border-input border-stone-400 bg-transparent px-3 py-1 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                    value={startTime}
